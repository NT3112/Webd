...
const CreateListing = () => {
  ...
  /*UPLOAD DRAG DROP AND REMOVE PHTOTOS*/
      ...
      <div className="create-listing">
        ...
        <form onSubmit={handlePost}>
          <div className="create-listing_step1">
            ...
            <br />
            <h3>Which of these categories best describes your page?</h3>
                    ...
                    {photos.length < 1 && (
                      <>
                        <input
                          id="image"
                          type="file"
                          style={{ display: "none" }} //isme dikkat aa rhi
                          accept="image/*"
          ...
          <button className="submit_btn" type="submit">CREATE A LISTING</button>
        </form>
      </div>
    </>
  );
